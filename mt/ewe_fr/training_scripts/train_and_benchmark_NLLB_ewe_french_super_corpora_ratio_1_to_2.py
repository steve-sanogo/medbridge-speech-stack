...
INPUT_TRAIN_CHAINED = RATIO_DIR / "test_baseline_plus_english_ewe_ratio_1_to_2.csv"

# SAVE_DIR_SPLIT = BASE_DIR / "data_preprocessing/ewe/splitting_baseline"
OUTPUT_DIR = BASE_DIR / "experiments/translation_ewe_french_super_corpus_ratio_1_to_2"
...
if __name__ == "__main__":
    ...
    print("*"*50)
    print(f"Script : train_and_benchmark_NLLB_ewe_french_super_corpora_ratio_1_to_2.py")
    print("*"*50)
    print(f"✅ Starting Ewe-French Training with Super Corpus Ratio 1:2")
