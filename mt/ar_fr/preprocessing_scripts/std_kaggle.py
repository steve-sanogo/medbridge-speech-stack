...
def standardize_kaggle_perfect_pairs():
    input_path = Path("/home/data/projets-aps/projet6/data/data_arab/Kaggle/train.csv")
    output_path = Path("/home/data/projets-aps/projet6/data_preprocessing/data_arab/standardized/Kaggle.csv")
...
if __name__ == "__main__":
    standardize_kaggle_perfect_pairs()